...
public class TestWebApplication {
    ...
    @Test
    @DisplayName("Fail with more than 1 command line argument")
    ...
    @Test
    @DisplayName("Port between min and max is valid")
    ...
    @Test
    @DisplayName("getServerPort uses specified port")
    ...
    @Test
    @DisplayName("getServerPort uses default for invalid argument")
    ...
    @Test
    @DisplayName("getServerPort uses default for out of range port")
